...
def simulate_game_q(black_player, white_player, board_size):
    moves = []
...
def main():
    ...
    agent1 = rl.load_q_agent(h5py.File(learning_agent, "r"))
    agent2 = rl.load_q_agent(h5py.File(learning_agent, "r"))
    ...
    for i in range(num_games+1):
        ...
        game_record = simulate_game_q(black_player, white_player, board_size)
        print(" № игры : ", i+1)
