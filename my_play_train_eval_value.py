...
def main():
    ...
    games_per_batch = int(input('Количество игр в пакете ='))  #1000
    num_workers = int(input('Количество процессов для обработки = '))
    ...
    experience_file = os.path.join(work_dir, 'exp_temp.hdf5')
